<script lang="ts">
    ...
    async function getHighScores() {
        const result = await axios.get("https://nftgame-3p92cu7fc-codifiest.vercel.app:3888/scores");
        return result.data;
    }
    ...
    function hitBomb(player, bomb) {
        ...
        async function updateScores() {
            const result = await axios.post("https://nftgame-3p92cu7fc-codifiest.vercel.app:3888/scores", {
